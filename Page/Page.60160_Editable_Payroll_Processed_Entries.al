page 60160 "EDITABLE Payroll Proc. Entries"
{
    PageType = List;
    //ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Payroll Processed Entry";
    Caption = 'EDITABLE Monthly Payroll Summaries';
