page 65058 "Rawat Inap Balance Perawatan"
{
    Caption = 'Rawat Inap - Biaya Jasa Perawatan';
    PageType = ListPart;
    UsageCategory = Lists;
    ...
    begin
        ...
        frz_LedgerMedical.SetRange("Rawat Inat Type", frz_LedgerMedical."Rawat Inat Type"::"Biaya Jasa Perawatan");
