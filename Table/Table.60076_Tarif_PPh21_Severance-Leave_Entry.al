table 60076 "Tarif PPh21 Sevr. Leave Entry"
{
    Caption = 'Tarif PPh21 Severance Leave Entry';
    DataClassification = CustomerContent;
    DrillDownPageId = "Tarif PPh21 Sevr-Leave Entries";
    ...
    fields
    {
        ...
        field(7; "Severance Ledger Entry No."; Integer)
        {
            DataClassification = CustomerContent;
        }
    }
