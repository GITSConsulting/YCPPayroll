report 65015 "Posted Unconditional Leave"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = './Report/Report.65015_Posted_Unconditional_Leave_Request.rdlc';
    DefaultLayout = RDLC;

    dataset
    {
        dataitem("Posted Unco Leave Request"; "Posted Unco Leave Request")
        {
