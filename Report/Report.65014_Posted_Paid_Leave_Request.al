report 65014 "Posted Paid Leave Request"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = './Report/Report.65007_Paid_Leave_Request.rdlc';
    DefaultLayout = RDLC;

    dataset
    {
        dataitem("Posted Leave Request"; "Posted Leave Request")
        {
