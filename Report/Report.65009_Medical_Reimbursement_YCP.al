report 65009 "Medical Reimbursement YCP"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = './Report/Report.65009_Medical_Reimbursement_YCP.rdlc';
    DefaultLayout = RDLC;

    dataset
    {
        dataitem("Medical Reimbursement Header"; "Medical Reimbursement Header")
        {
            ...
            dataitem("Medical Reimbursement Line"; "Medical Reimbursement Line")
            {
                DataItemLink = "Document No." = field("No.");
                column(Document_No_; "Document No.") { }
                column(Rawat_Inat_Type; "Rawat Inat Type") { }
                column(Medical_Value; frz_DescMedicalValues) { }
                column(Medical_Value2; frz_DescMedicalValues) { }
                ...
                begin
                    ...
                    frz_MedivalValues.SetRange(Code, "Medical Reimbursement Line"."Medical Value");
